        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <p></p>
                    ...
                    <a href="<?php echo base_url(); ?>crud/viewadminhomepesanan" class="list-group-item">Pesanan</a>
                </div>
            </div>
            ...
            <div class="col-md-9">
                <div class="table-title">
                    ...
                    <tr>
                    <td class="text-left"><img src="<?php echo base_url().$d['image'] ?>" height="100px" width="100px"></td>
                    ...
                    <td class="text-left"><a href="<?= base_url().'crud/viewformedit/'.$d['id'] ?>"><button><span style="color: black">edit</span></button></a></td>
                    <td class="text-left"><a href="<?= base_url().'crud/delete/'.$d['id'] ?>"><button><span style="color: black">delete</span></button></a></td>
                    </tr>
                    <?php } ?>
                    </tbody>
                    </table>
                    <br><a href="<?= base_url() ?>crud/viewformadd"><button><span style="color: black">INSERT</span></button></a>

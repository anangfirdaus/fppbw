		...
		<div class="container">
			...
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2">
					<form class="form-inline" method="POST" action="<?php echo base_url("crud/insertpemesanan"); ?>">
						...
						<div class="col-md-6 col-sm-6">
							<div class="form-group">
								<?=$captcha_image?>&nbsp;<a href="#" onclick="parent.window.location.reload(true)"><button>refresh</button></a>
							</div>
						</div>
						<div class="col-md-6 col-sm-6">
							<div class="form-group">

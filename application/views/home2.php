    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <img src="<?php echo base_url()?>gambar/logo.jpg" height=250px width=250px>
            </div>
            ...
            <div class="row">
                        <form class="navbar-form navbar-right" method="POST" action="<?php echo site_url("crud/search_keyword")?>">
                    ...
                    <div class="form-group">
                        <?php echo form_input(['name'=>'keyword','class' => 'form-control','placeholder'=>'Search']); ?>
                    </div>
                    <?php echo form_submit(['value'=>'Search','class' => 'btn btn-primary']); ?>
                    <?php echo form_close(); ?>
                    <?php echo form_error('keyword','<div class="text-danger">','</div>'); ?> -->
            <div class="col-md-12">
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <h5>Harga : Rp <?php echo $d['harga'] ?></h5>
                                <h5>Size : </h5>
                            </div>
                        </div>
                    </div>
